...
# Find SecureFeePaymentCreateView
for i, line in enumerate(lines):
    if 'class SecureFeePaymentCreateView' in line:
        ...
        simple_class = '''class SecureFeePaymentCreateView(LoginRequiredMixin, UserPassesTestMixin, CreateView):
    model = FeePayment
    form_class = PaymentForm
    template_name = 'core/finance/fees/fee_payment_form.html'

    def test_func(self):
        """Test that the user has financial permissions."""
    ...
    def get_success_url(self):
        ...
        # Replace the class
        lines[class_start:class_end] = [line + '\\n' for line in simple_class.split('\\n')]
        break

with open('core/views/fee_views.py', 'w') as file:
    file.writelines(lines)

print("✓ Created simple working SecureFeePaymentCreateView")
