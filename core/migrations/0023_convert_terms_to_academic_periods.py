# core/migrations/0024_add_academic_period_fields.py - FIXED
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0022_userprofile_has_financial_access'),  # Replace with your actual last migration number
    ]
    ...
    operations = [
        ...
        # Remove old term field - BUT WE SHOULD DO THIS LATER AFTER DATA MIGRATION
        # Let's comment this out for now and do it in a separate migration
        # migrations.RemoveField(
        #     model_name='academicterm',
        #     name='term',
        # ),
        
        # Update unique constraint - CORRECTED SYNTAX
