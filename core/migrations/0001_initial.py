# Generated by Django 4.2.26 on 2025-11-29 04:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('TUITION', 'Tuition Fees'), ('ADMISSION', 'Admission Fees'), ('TRANSPORT', 'Transport Fees'), ('TECHNOLOGY', 'Technology Fee'), ('EXAMINATION', 'Examination Fees'), ('UNIFORM', 'Uniform Fees'), ('PTA', 'PTA Fees'), ('EXTRA_CLASSES', 'Extra Classes Fees')], max_length=100)),
                ('description', models.TextField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allow_staff_access', models.BooleanField(default=True, help_text='Allow all staff users to access the system during maintenance')),
                ('allow_superuser_access', models.BooleanField(default=True, help_text='Allow all superusers to access the system during maintenance')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('allowed_users', models.ManyToManyField(blank=True, help_text='Users who can access the system during maintenance', related_name='maintenance_bypass_users', to=settings.AUTH_USER_MODEL)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_level', models.CharField(blank=True, choices=[('P1', 'Primary 1'), ('P2', 'Primary 2'), ('P3', 'Primary 3'), ('P4', 'Primary 4'), ('P5', 'Primary 5'), ('P6', 'Primary 6'), ('J1', 'JHS 1'), ('J2', 'JHS 2'), ('J3', 'JHS 3')], help_text="Student's class level (auto-set from student)", max_length=2, null=True, verbose_name='Class Level')),
                ...
                ('class_assignment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='grades', to='core.classassignment')),
